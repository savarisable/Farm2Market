...
export async function processMultilingualQuery(
  ...
  if (
    ...
    if (lang === 'mr') {
      reply = `🎯 **आमच्या AI चे खरे सामर्थ्य: फेअर प्राईस इंजिन (Fair Price Engine)**\n\n` +
        `पारंपारिक व्यवस्थेत शेतकऱ्यांना इतर शहरांमधील नेमके बाजारभाव ठाऊक नसतात, ज्याचा गैरफायदा मध्यस्थ घेतात. **Farm2Market AI ही माहितीची दरी (Information Asymmetry) कायमची मिटवते:**\n\n` +
      ...
      reply = `🎯 **हमारे AI का असली मूल्य: फेयर प्राइस इंजन (Fair Price Engine)**\n\n` +
        `पारंपरिक मंडियों में किसानों को महानगरों की वास्तविक मांग और सही दरों की जानकारी नहीं होती, जिससे बिचौलिए उनका शोषण करते हैं। **Farm2Market AI इसी सूचना विषमता (Information Asymmetry) का समाधान करता है:**\n\n` +
  ...
  if (lang === 'mr') {
    return {
      reply: `नमस्कार! मी **Farm2Market AI सल्लागार** आहे 🌾\n\n` +
    ...
    return {
      reply: `नमस्ते! मैं आपका **Farm2Market AI कृषि सलाहकार** हूँ 🌾\n\n` +
